...
class XML
	...
	public:
		...
		static XMLElement* Paste(char* txt = 0, UINT uFormat = CF_TEXT);
		...
		int Save(const TCHAR* file = 0,XML_SAVE_MODE SaveMode = XML_SAVE_MODE_DEFAULT,XML_TARGET_MODE TargetMode = XML_TARGET_MODE_FILE,class XMLTransform* eclass = 0,class XMLTransformData* edata = 0); // Default, do not encode already encoded
