...
public:
	...
	TCHAR m_szFileTitle[128*(_MAX_PATH + 1) +1];   // contains file title after return
	TCHAR m_szFileName[128*(_MAX_PATH + 1) +1];     // contains full path name after return
			...
			HWND hWndParent = NULL)
	{
		...
		m_ofn.nMaxFile = 128*(_MAX_PATH + 1) +1;
