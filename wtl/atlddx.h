...
#define DDX_COMBO_INDEX(nID, var) \
		if(nCtlID == (UINT)-1 || nCtlID == nID) \
			DDX_Combo_Index(nID, var, TRUE, bSaveAndValidate); \
...
//Combo Exchange
	BOOL DDX_Combo_Index(UINT nID, int& nVal, BOOL bSigned, BOOL bSave, BOOL bValidate = FALSE, int nMin = 0, int nMax = 0)
	{
